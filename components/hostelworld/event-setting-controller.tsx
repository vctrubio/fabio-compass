            ...
            <div className="flex items-center gap-2 px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center bg-white dark:bg-gray-800 border rounded">
                        ...
                        {/* Time Display */}
                        <div className="px-3 py-1 text-sm font-mono">{submitTime}</div>
                    ...
                    <div className="flex items-center gap-1">
                        {["11:00", "13:00", "16:00"].map((time) => (
                            <button
                                ...
                                className={`px-2 py-1 text-xs rounded transition-colors ${submitTime === time
        ...
        <div className="flex items-center border rounded-lg bg-white dark:bg-gray-800">
            {options.map((option) => (
                <button
                    ...
                    className={`px-3 py-1.5 text-xs hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ${value === option.value
                        ? "bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300"
                        : ""
                        }`}
                >
    ...
    <div className="flex items-center gap-2 px-3 py-2 bg-gray-100 dark:bg-gray-700 rounded">
        ...
        <div className="flex items-center border rounded-lg bg-white dark:bg-gray-800">
            <button
                ...
                className={`px-3 py-1.5 text-xs hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ${location === "Los Lances"
                    ? "bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300"
                    : ""
                    }`}
            >
            ...
            <button
                ...
                className={`px-3 py-1.5 text-xs hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors ${location === "Valdevaqueros"
                    ? "bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300"
                    : ""
                    }`}
            >
