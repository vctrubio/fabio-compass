...
import { formatDate, formatTime } from "@/components/getters";
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="text-sm font-medium text-gray-800 dark:text-gray-200">
              {formatDate(booking.model.date_start)} - {formatDate(booking.model.date_end)}
            </div>
            <div className="text-xs text-gray-500 dark:text-gray-400">
              {formatTime(booking.model.date_start)} - {formatTime(booking.model.date_end)}
            </div>
          </div>
        </div>
      </div>
...
export default function WhiteboardPlanning({ bookingsData, teachersData }: WhiteboardPlanningProps) {
    return (
        <div className="p-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg border">
            ...
            <div className="space-y-6">
                ...
                {/* Bookings list section - newly added */}
                <BookingsList bookingsData={bookingsData} />
            </div>
        </div>
    );
